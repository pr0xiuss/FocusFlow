...
async function apiDeleteTask(id) {
    ...
    try {
        ...
        if (res.status === 500) {
            console.log('Server returned 500, but delete might have worked');
            return true; 
        }
        ...
        console.log('Unexpected status, but assuming delete succeeded:', res.status);
        return true;
